...
new_df <- new_df[-c(13, 34, 60, 71, 83, 98, 104, #participants with numbers as ID
                    119, 124, 130), ] # participants with names as ID
# Participants med navne, der skal fjernes: 
# "Banan", "Duc7", "fluy", "Julemor", 
...
# calculating the number of people who changed their answers
class(new_df$ændre_svar)
new_df$ændre_svar <- as.factor(new_df$ændre_svar)

nyt_svar <- data.frame(ID = sample(letters, 132, rep = TRUE))
nyt_svar %>% 
